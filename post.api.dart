...
class _ProductbuttonState extends State<Productbutton> {
                  ...
                  return ListTile(
                    title: Column(
                      children: [
                        ...
                        Text('${product.rating}'),
                        Image.network(product.thumbnail ?? 'Thumbnail'),
                      ],
                    ),
                  );
                },
  ...
  void _addProduct() async {
    ...
    // Handle the response here, you can check if the request was successful
    // and update the UI or show a confirmation message accordingly.
    ...
    // Reload the product list to display the newly added product.
    loadProductsAndNavigate();
  }
}
